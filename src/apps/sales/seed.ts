/** SalesApp — local seed for the editorial Today / Pipeline / Context /
 *  Capabilities / Stack / Cognition sections.
 *
 ...
 *
 *  The former `sales_snapshot` and `sales_stages` CMS collections were
 *  retired on 2026-08-10. Their literal numbers were disconnected from
 *  the live deal data (the deals collection held 5 deals totaling ~$9.6k,
 *  while the snapshot claimed "$486k pipeline / 54 open deals"). The
 *  Pipeline panel now derives its tiles from the live `deals` collection
 *  inside SalesApp.tsx.
 *
 *  Remaining sections (TRENDS/SCORES/CONTEXT/SKILLS/ROUTINES/STACK) stay
 *  as CMS collections with editorial content; they each have their own
 *  source and were not in scope of the 2026-08-10 debt pass.
 */
...
/* ═══ Snapshot — retired 2026-08-10. Pipeline tiles now derive from the
 *     live `deals` collection inside SalesApp.tsx. The literal numbers
 *     used to claim "$486k pipeline / 54 open deals" against a deals
 *     collection of 5 items totaling ~$9.6k. ═══ */

/* ═══ Stages — retired 2026-08-10. Stage tiles now derive from the
 *     live `deals` collection inside SalesApp.tsx. ═══ */
