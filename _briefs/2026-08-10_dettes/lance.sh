...
ID="${1:?usage: ./lance.sh <A_SALES_LEGAL|B_PEOPLE_PLATFORM>}"
...
CAMP="$DEPOT/_briefs/2026-08-10_dettes"
...
case "$ID" in
  A_SALES_LEGAL)      BRIEF="$CAMP/BRIEF_A_SALES_LEGAL.md";      CRIT="" ;;
  B_PEOPLE_PLATFORM)  BRIEF="$CAMP/BRIEF_B_PEOPLE_PLATFORM.md";  CRIT="" ;;
