...
ID="${1:?usage: ./lance.sh <D_DASHBOARD|B_BUSINESS|O_OPS>}"
...
CAMP="$DEPOT/_briefs/2026-08-10_vague3"
...
case "$ID" in
  D_DASHBOARD) BRIEF="$CAMP/BRIEF_D_DASHBOARD.md"; CRIT="$CAMP/CRITERES.md" ;;
  B_BUSINESS)  BRIEF="$CAMP/BRIEF_B_BUSINESS.md";  CRIT="$CAMP/CRITERES.md" ;;
  O_OPS)       BRIEF="$CAMP/BRIEF_O_OPS.md";       CRIT="$CAMP/CRITERES.md" ;;
