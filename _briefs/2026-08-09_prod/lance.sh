...
ID="${1:?usage: ./lance.sh <A_SOCLE|B_DASHBOARD|C_BUSINESS|D_OPS|E_PERIPHERIE>}"
...
CAMP="$DEPOT/_briefs/2026-08-09_prod"
...
case "$ID" in
  A_SOCLE)      BRIEF="$CAMP/BRIEF_A_SOCLE.md";      CRIT="" ;;
  B_DASHBOARD)  BRIEF="$CAMP/BRIEF_B_DASHBOARD.md";  CRIT="" ;;
  C_BUSINESS)   BRIEF="$CAMP/BRIEF_C_BUSINESS.md";   CRIT="$CAMP/CRITERES.md" ;;
  D_OPS)        BRIEF="$CAMP/BRIEF_D_OPS.md";        CRIT="$CAMP/CRITERES.md" ;;
  E_PERIPHERIE) BRIEF="$CAMP/BRIEF_E_PERIPHERIE.md"; CRIT="$CAMP/CRITERES.md" ;;
